...
import type { AppSettings, ClipHistoryItem, ExportResult, StreamMetadata } from "@shared/domain";
import type { ExportRequest, SettingsUpdateRequest } from "@shared/validation";
